                ...
                {editando && (
                    <div className="mb-6 p-6 bg-[#e1e8b8] rounded-[30px] shadow-sm">
                        ...
                        <div className="flex flex-col flex-wrap sm:flex-row gap-2 px-[17%]">
                            ...
                            <button onClick={salvarEdicao} className="text-[25px] w-[155px] tracking-wider rounded-[29px] bg-[#02b47f] text-[#17563e] pr-8 pl-8 hover:bg-[#17563e] hover:text-[#02b47f] transition">
                                Salvar
                            </button>
                            <button onClick={cancelarEdicao} className="text-[25px] w-[155px] tracking-wider rounded-[29px] bg-[#b40202] text-[#561717] pr-8 pl-8 hover:bg-[#561717] hover:text-[#b40202] transition">
                                Cancelar
                            </button>
                        </div>
                    </div>
                        ...
                        <li key={meta.id} className="mb-4 p-4 bg-[#B8E8E4] rounded-[29px] shadow-sm">
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex gap-2">
                                    <button onClick={() => iniciarEdicao(meta)} className="py-1 text-[30px] tracking-wider rounded-[29px] bg-[#b4a802] text-[#525617] pr-8 pl-8 hover:bg-[#525617] hover:text-[#b4a802] transition">
                                        Editar
                                    </button>
                                    <button onClick={() => excluirMeta(meta.id)} className="text-[30px] tracking-wider rounded-[29px] bg-[#b40202] text-[#561717] pr-8 pl-8 hover:bg-[#561717] hover:text-[#b40202] transition">
                                        Excluir
                                    </button>
                                </div>
                            </div>
